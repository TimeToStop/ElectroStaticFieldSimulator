...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        scale_box = new QComboBox(m_additional_group_box);
        scale_box->addItem(QString());
        scale_box->addItem(QString());
        scale_box->addItem(QString());
        scale_box->addItem(QString());
        scale_box->addItem(QString());
        ...
        scale_box->addItem(QString());
        scale_box->addItem(QString());
        scale_box->setObjectName(QString::fromUtf8("scale_box"));

        gridLayout_10->addWidget(scale_box, 0, 1, 1, 1);
        ...
        sizePolicy3.setHeightForWidth(m_position_group_box->sizePolicy().hasHeightForWidth());
        m_position_group_box->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(m_info_charges_label->sizePolicy().hasHeightForWidth());
        m_info_charges_label->setSizePolicy(sizePolicy4);
        ...
        QObject::connect(scale_box, SIGNAL(currentIndexChanged(int)), MainWindow, SLOT(scaleChanged(int)));

        scale_box->setCurrentIndex(4);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        scale_box->setItemText(0, QCoreApplication::translate("MainWindow", "pm", nullptr));
        scale_box->setItemText(1, QCoreApplication::translate("MainWindow", "nm", nullptr));
        scale_box->setItemText(2, QCoreApplication::translate("MainWindow", "mcm", nullptr));
        scale_box->setItemText(3, QCoreApplication::translate("MainWindow", "mm", nullptr));
        scale_box->setItemText(4, QCoreApplication::translate("MainWindow", "m", nullptr));
        scale_box->setItemText(5, QCoreApplication::translate("MainWindow", "km", nullptr));
        scale_box->setItemText(6, QCoreApplication::translate("MainWindow", "Mm", nullptr));
        scale_box->setItemText(7, QCoreApplication::translate("MainWindow", "Gm", nullptr));
        scale_box->setItemText(8, QCoreApplication::translate("MainWindow", "Tm", nullptr));

        scale_box->setCurrentText(QCoreApplication::translate("MainWindow", "m", nullptr));
        ...
        m_info_system_kenergy_label->setText(QCoreApplication::translate("MainWindow", "\316\243 Ek", nullptr));
        m_info_system_sum_energy_label->setText(QCoreApplication::translate("MainWindow", "\316\243 W", nullptr));
